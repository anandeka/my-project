...
AS
   SELECT pci.internal_contract_item_ref_no AS internal_contract_item_ref_no,
          ...
          PCDB.CITY_ID AS origination_city_id,
          PCDB.STATE_ID  AS origination_state_id,
          PCDB.COUNTRY_ID  AS origination_country_id,
          PCDB.CITY_ID AS destination_city_id,
          PCDB.STATE_ID AS destination_state_id,
          PCDB.COUNTRY_ID AS destination_country_id,
