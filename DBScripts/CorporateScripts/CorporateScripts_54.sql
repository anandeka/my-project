Insert into DRFM_DOC_REF_NO_MAPPING
 ...
 Values
   ('DRFM-DC-1', 'LDE', 'CREATE_DC', 'DC_KEY_1', 'N');
   
Insert into DRFM_DOC_REF_NO_MAPPING
   (DOC_REF_NO_MAPPING_ID, CORPORATE_ID, DOC_ID, DOC_KEY_ID, IS_DELETED)
 Values
   ('DRFM-DC-2', 'EKA', 'CREATE_DC', 'DC_KEY_2', 'N');
...
Insert into CDC_CORPORATE_DOC_CONFIG
 ...
 Values
   ('CDC-DC-1', 'LDE', 'CREATE_DC', 'DebitCredit', NULL, 
...
Insert into CDC_CORPORATE_DOC_CONFIG
   (DOC_TEMPLATE_ID, CORPORATE_ID, DOC_ID, DOC_TEMPLATE_NAME, DOC_TEMPLATE_NAME_DE, 
    ...
    IS_ACTIVE, DOC_AUTO_GENERATE)
 Values
   ('CDC-DC-2', 'EKA', 'CREATE_DC', 'DebitCredit', NULL, 
    NULL, NULL, NULL, NULL, 'PurchaseDebitCreditNote.rpt', 
    'Y', 'Y');
...
Insert into DRFM_DOC_REF_NO_MAPPING
   (DOC_REF_NO_MAPPING_ID, CORPORATE_ID, DOC_ID, DOC_KEY_ID, IS_DELETED)
 Values
   ('DRFM-SI-1', 'LDE', 'CREATE_SI', 'SI_KEY_1', 'N');
   
Insert into DRFM_DOC_REF_NO_MAPPING
   (DOC_REF_NO_MAPPING_ID, CORPORATE_ID, DOC_ID, DOC_KEY_ID, IS_DELETED)
 Values
   ('DRFM-SI-2', 'EKA', 'CREATE_SI', 'SI_KEY_2', 'N');
   
Insert into DRF_DOC_REF_NUMBER_FORMAT
   (DOC_REF_NUMBER_FORMAT_ID, DOC_KEY_ID, CORPORATE_ID, PREFIX, MIDDLE_NO_START_VALUE, 
    MIDDLE_NO_LAST_USED_VALUE, SUFFIX, VERSION, IS_DELETED)
 Values
   ('DRF-SI-1', 'SI_KEY_1', 'LDE', 'SI-', 0, 
    0, '-LDE', 1, 'N');
...
Insert into CDC_CORPORATE_DOC_CONFIG
   (DOC_TEMPLATE_ID, CORPORATE_ID, DOC_ID, DOC_TEMPLATE_NAME, DOC_TEMPLATE_NAME_DE, 
    ...
    IS_ACTIVE, DOC_AUTO_GENERATE)
 Values
   ('CDC-SI-1', 'LDE', 'CREATE_SI', 'Service', NULL, 
...
Insert into CDC_CORPORATE_DOC_CONFIG
   (DOC_TEMPLATE_ID, CORPORATE_ID, DOC_ID, DOC_TEMPLATE_NAME, DOC_TEMPLATE_NAME_DE, 
    ...
    IS_ACTIVE, DOC_AUTO_GENERATE)
 Values
   ('CDC-SI-2', 'EKA', 'CREATE_SI', 'Service', NULL, 
    NULL, NULL, NULL, NULL, 'A', 
    'Y', 'Y');
