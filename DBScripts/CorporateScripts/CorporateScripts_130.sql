...
DROP SEQUENCE SEQERC_DFT_PFI_BLD;
DROP SEQUENCE SEQERC_DFT_PFI_BAT;
DROP SEQUENCE SEQERC_DFT_PFI_BAM;
DROP SEQUENCE SEQERC_DFT_PFI_LDE;
DROP SEQUENCE SEQ_DFT_PFI_BLD;
DROP SEQUENCE SEQ_DFT_PFI_BAM;
DROP SEQUENCE SEQ_DFT_PFI_BAT;
DROP SEQUENCE SEQ_DFT_PFI_LDE;
...
--EXECUTE IMMEDIATE vn_drop_stmt;
 ...
 Values
   (cc.CORPORATE_ID, 'CREATE_DFT_PFI', 'DFT-PFI-', 0, '-'||cc.CORPORATE_ID, 
    'N', 'Dummy');
