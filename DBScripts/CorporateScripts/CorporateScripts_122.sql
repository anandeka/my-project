...
Begin
  ...
  loop
    ...
    Insert into RFC_REPORT_FILTER_CONFIG
       (CORPORATE_ID, REPORT_ID, LABEL_ID, LABEL_COLUMN_NUMBER, LABEL_ROW_NUMBER, LABEL, FIELD_ID, COLSPAN, IS_MANDATORY)
     Values
       (rc.corp_id, '370', 'RFC370PHY04', 1, 5, 'Product', 'GFF1011', 1, 'Y');
...
--------------------------------------------------------------------------------------------------------------------------
    ...
    Insert into RFC_REPORT_FILTER_CONFIG
       (CORPORATE_ID, REPORT_ID, LABEL_ID, LABEL_COLUMN_NUMBER, LABEL_ROW_NUMBER, LABEL, FIELD_ID, COLSPAN, IS_MANDATORY)
     Values
       (rc.corp_id, '372', 'RFC372PHY04', 1, 5, 'Product', 'GFF1011', 1, 'Y');
   ...
   Insert into RFC_REPORT_FILTER_CONFIG
		...
		Insert into RFC_REPORT_FILTER_CONFIG
		   (CORPORATE_ID, REPORT_ID, LABEL_ID, LABEL_COLUMN_NUMBER, LABEL_ROW_NUMBER, LABEL, FIELD_ID, COLSPAN, IS_MANDATORY)
		 Values
		   (rc.corp_id, '369', 'RFC369PHY04', 1, 5, 'Product', 'GFF1011', 1, 'Y');
...
--------------------------------------------------------------------------------------------------------
	...
	Insert into RFC_REPORT_FILTER_CONFIG
        ...
        Insert into RFC_REPORT_FILTER_CONFIG
           (CORPORATE_ID, REPORT_ID, LABEL_ID, LABEL_COLUMN_NUMBER, LABEL_ROW_NUMBER, LABEL, FIELD_ID, COLSPAN, IS_MANDATORY)
         Values
           (rc.corp_id, '371', 'RFC371PHY04', 1, 5, 'Product', 'GFF1011', 1, 'Y');
...
*/
 --Year Filter
        ...
        Insert into RFC_REPORT_FILTER_CONFIG
           (CORPORATE_ID, REPORT_ID, LABEL_ID, LABEL_COLUMN_NUMBER, LABEL_ROW_NUMBER, LABEL, FIELD_ID, COLSPAN, IS_MANDATORY)
         Values
           (rc.corp_id, '373', 'RFC373PHY04', 1, 5, 'Product', 'GFF1011', 1, 'Y');
    ...
    Insert into RFC_REPORT_FILTER_CONFIG
      (CORPORATE_ID,
       ...
       IS_MANDATORY)
    Values
      (rc.corp_id, '374', 'RFC374PHY01', 1, 1, 'Year', 'GFF1012', 1, 'Y');
    ...
    Values
      (rc.corp_id, '374', 'RFC374PHY01', 'RFP1060', 'yearList');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY01', 'RFP1062', 'Yes');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY01', 'RFP1063', 'Filter');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY01', 'RFP1064', 'reportForm');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY01', 'RFP1065', '1');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY01', 'RFP1066', 'Yes');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY01', 'RFP1061', 'Year');
    ...
    Insert into RFC_REPORT_FILTER_CONFIG
      (CORPORATE_ID,
       ...
       IS_MANDATORY)
    Values
      (rc.corp_id, '374', 'RFC374PHY02', 1, 2, 'Month', 'GFF1012', 1, 'Y');
    ...
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY02', 'RFP1060', 'MonthList');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY02', 'RFP1062', 'Yes');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY02', 'RFP1061', 'Month');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY02', 'RFP1063', 'Filter');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY02', 'RFP1064', 'reportForm');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY02', 'RFP1065', '1');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY02', 'RFP1066', 'Yes');
    ...
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY04', 'RFP1045', 'allProducts');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY04', 'RFP1046', 'Product');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY04', 'RFP1047', 'No');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY04', 'RFP1048', 'Filter');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY04', 'RFP1049', 'reportForm');
    Insert into RPC_RF_PARAMETER_CONFIG
      (CORPORATE_ID,
       REPORT_ID,
       LABEL_ID,
       ...
       REPORT_PARAMETER_NAME)
    Values
      (rc.corp_id, '374', 'RFC374PHY04', 'RFP1050', '1');
