              ...
              if vc_inst_price_status_flag <> 'Error' then
                ...
                loop
                  ...
                  .tradedate <= vd_qp_end_date then
                    dbms_output.put_line('i = ' || i || ' trade date ' ||
                                         to_char(vc_tbl(i).tradedate,
                                                 'dd-Mon-yyyy') ||
                                         ' vc_tbl(i).price ' || vc_tbl(i)
                                         .price ||
                                         'vc_tbl(i).price_unit_id ' ||
                                         vc_tbl(i)
                                         .price_unit_id || ' Is holiday : ' ||
                                         vc_tbl(i).isholiday);
                ...
                if vn_instrumnet_cnt <> 0 then
                  ...
                  dbms_output.put_line('******************' ||
                                       'The instrument wist average price is  ' ||
                                       vn_instrument_avg ||
                                       '************************');
                else
                  vn_instrument_avg := 0;
    ...
    if vc_inst_tbl.exists(1) and vobj_fb_tbl_setup.exists(1) then
      ...
      begin
        ...
        loop
          ...
          if  vc_inst_tbl(1).v_tbl_formula(i)  .vd_avl_price_date = vc_inst_tbl(1).v_tbl_formula(i).tradedate then
