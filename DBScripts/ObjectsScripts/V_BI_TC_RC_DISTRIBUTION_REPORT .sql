...
select supplier.supplier_invoive_no,
  ...
  from (select test.supplier_gmr_ref_no,
          ...
          from (select pcm.internal_contract_ref_no supplier_contract_ref_no,
                       gmr.internal_gmr_ref_no supplier_gmr_ref_no,
                       ...
                       iss.internal_invoice_ref_no supplier_invoive_no,
         ...
         group by test.supplier_invoive_no,
                  ...
                  test.invoice_currency_id,
                  test.invoice_currency_code,
                  test.supplier_gmr_ref_no) supplier,
       (select test.smelter_gmr_ref_no,
               ...
               test.invoice_currency_id,
               test.invoice_currency_code
          from (select pcm.internal_contract_ref_no smelter_contract_ref_no,
                       gmr.internal_gmr_ref_no smelter_gmr_ref_no,
                       grd.internal_grd_ref_no ,
                       ...
                       nvl(inrc.rc_amount, 0) rc_amount,
                       nvl(iepd.penality_amount, 0) penality_amount,
                       iss.internal_invoice_ref_no smelter_invoive_no,
         ...
         group by test.smelter_invoive_no,
                  ...
                  test.supp_internal_gmr_ref_no) smelter
 where supplier.supplier_gmr_ref_no = smelter.supp_internal_gmr_ref_no(+)
