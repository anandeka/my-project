...
select 'Invoice' section_name,
       ...
       --ispcd.invoice_amount provisional_amount,
       api_d.api_amount_adjusted provisional_amount,
       '' amount_due,
       isd.addditional_charges,
       isd.taxes,
       isd.contract_type product_type,
...
select 'Invoice' section_name,
  ...
  from is_d isd,
       ...
       (select istc.internal_doc_ref_no,
               ...
               istc.element_name,
               istc.sub_lot_no || (case
                 when istc.assay_detail is null then
                  ''
                 else
                  ' : ' || istc.assay_detail
               end) sub_lot_no,
...
select 'Invoice' section_name,
  ...
  from is_d isd,
       ...
       (select isrc.internal_doc_ref_no,
               ...
               isrc.element_name,
               isrc.sub_lot_no || (case
                 when isrc.assay_content is null then
                  ''
                 else
                  ' : ' || isrc.assay_content
               end) sub_lot_no,
