...
AS
   SELECT gmr.corporate_id, gmr.internal_gmr_ref_no, gmr.gmr_ref_no,
          ...
          phd_pledge.companyname pledge_cp_name, axs.action_id,
          axm.action_name action_name, axs.internal_action_ref_no,
          axs.eff_date activity_date, axs.action_ref_no, gmr.qty,
          NVL (gepd.internal_pledge_qty, 0) internal_pledge_qty,
          gmr.qty_unit_id, qum.qty_unit, gepd.element_id,
          aml.attribute_name element_name, gepd.product_id,
          pdm.product_desc product_name, gepd.element_type,
