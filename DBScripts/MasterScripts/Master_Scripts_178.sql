...
delete from DC_DOCUMENT_CONFIGURATION  where ACTIVITY_ID in ('CREATE_PFD','CREATE_PRICE_FIXATION');

delete from ADM_ACTION_DOCUMENT_MASTER where doc_id in ('CREATE_PFD','CREATE_PRICE_FIXATION');
...
delete from DM_DOCUMENT_MASTER where doc_id in ('CREATE_PFD','CREATE_PRICE_FIXATION');
