declare
fetchQryIEPD CLOB := 'INSERT INTO iepd_d
...
begin
    UPDATE DGM_DOCUMENT_GENERATION_MASTER dgm set DGM.FETCH_QUERY = fetchQryIEPD where DGM.DOC_ID IN ('CREATE_DFI','CREATE_FI') and DGM.DGM_ID IN ('DGM-IEPD_C') and DGM.IS_CONCENTRATE = 'Y' and DGM.SEQUENCE_ORDER = 13;
commit;
end;