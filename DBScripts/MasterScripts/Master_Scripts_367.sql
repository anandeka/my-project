DECLARE
   fetchquery1   CLOB := 'INSERT INTO IS_D (
INVOICE_REF_NO,
INVOICE_TYPE_NAME,
...
sum(INVS.INVOICED_QTY) as INVOICE_QUANTITY,
stragg(distinct QUM_GMR.QTY_UNIT) as INVOICED_QTY_UNIT,
...
BEGIN
   UPDATE dgm_document_generation_master dgm
      SET dgm.fetch_query = fetchquery1
    WHERE dgm.dgm_id IN ('10', '11', '12')
      AND dgm.doc_id IN ('CREATE_DFI', 'CREATE_FI', 'CREATE_PI')
