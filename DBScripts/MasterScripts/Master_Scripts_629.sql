DECLARE fetchQueryIPCD CLOB := 'INSERT INTO is_parent_child_d
...
BEGIN
UPDATE DGM_DOCUMENT_GENERATION_MASTER DGM SET DGM.FETCH_QUERY=fetchQueryIPCD WHERE DGM.DGM_ID IN ('DGM-FI-C5','DGM-PI-C5','DGM-DFI-C5') AND DGM.DOC_ID IN ('CREATE_DFI','CREATE_FI','CREATE_PI') AND DGM.SEQUENCE_ORDER IN (5) AND DGM.IS_CONCENTRATE = 'N';
COMMIT;
END;