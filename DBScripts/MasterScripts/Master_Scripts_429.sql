update DGM_DOCUMENT_GENERATION_MASTER dgm set DGM.SEQUENCE_ORDER = (DGM.SEQUENCE_ORDER+1) where DGM.DOC_ID = 'CREATE_API';

declare
fetchQry1 CLOB := 'INSERT INTO API_D (
...
begin
   update DGM_DOCUMENT_GENERATION_MASTER dgm set DGM.FETCH_QUERY = fetchQry1 where DGM.DOC_ID = 'CREATE_API' and DGM.DGM_ID IN('DGM-API-1','DGM-API-1-CONC'); 
end;
...
INSERT INTO dgm_document_generation_master
     ...
     VALUES ('DGM-API-1-1', 'CREATE_API', 'Advance Payment Invoice',
             'CREATE_API', 1, fetchQry1, 'N'
            );
INSERT INTO dgm_document_generation_master
            (dgm_id, doc_id, doc_name,
             activity_id, sequence_order, fetch_query, is_concentrate
            )
     VALUES ('DGM-API-1-1-CONC', 'CREATE_API', 'Advance Payment Invoice',
             'CREATE_API', 1, fetchQry1 , 'Y'
            );    
commit;
end;