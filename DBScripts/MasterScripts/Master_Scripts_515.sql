...
fetchQryISDConc CLOB := 'INSERT INTO is_d
   ...
   SELECT   invs.invoice_ref_no AS invoice_ref_no,
            ...
            NVL (akuser.login_name, '''') AS our_person_incharge,INVS.INTERNAL_COMMENTS as internal_comments, pcm.is_self_billing, ?
       FROM is_invoice_summary invs,
...
fetchQryISDBM CLOB := 'INSERT INTO is_d
   ...
   SELECT   invs.invoice_ref_no AS invoice_ref_no,
            ...
            invs.invoice_adjustment_amount As adjustment_amount,
            NVL (akuser.login_name, '''') AS our_person_incharge, pcm.is_self_billing, ?
       FROM is_invoice_summary invs,
            iid_invoicable_item_details iid,
            pcm_physical_contract_main pcm,
            v_pci pci,
...
INVS.INTERNAL_COMMENTS as INTERNAL_COMMENTS, pcm.is_self_billing as SELF_BILLING, 
?
from 
...
fetchQryISDAPIBM CLOB := 'INSERT INTO is_d
            (internal_invoice_ref_no, cp_name, cp_item_stock_ref_no,
             ...
             our_person_incharge, is_self_billing, internal_doc_ref_no)
   SELECT   invs.internal_invoice_ref_no AS internal_invoice_ref_no,
            ...
            invs.internal_comments AS internal_comments,
            akuser.login_name AS our_person_incharge, pcm.is_self_billing as SELF_BILLING, ?
       FROM is_invoice_summary invs,
...
fetchQryISDAPIConc CLOB := 'INSERT INTO is_d
   ...
   SELECT   invs.internal_invoice_ref_no AS internal_invoice_ref_no,
            ...
            invs.total_other_charge_amount AS total_other_charge_amount,
            invs.internal_comments AS internal_comments,
            akuser.login_name AS our_person_incharge, pcm.is_self_billing, ?
       FROM is_invoice_summary invs,
            apid_adv_payment_item_details apid,
            pcm_physical_contract_main pcm,
            v_pci pci,
...
PAYMENT_TERM,
CONTRACT_TYPE,
internal_comments, internal_doc_ref_no
)
select
INVS.INTERNAL_INVOICE_REF_NO as INTERNAL_INVOICE_REF_NO,
INVS.INVOICE_REF_NO as INVOICE_REF_NO,
