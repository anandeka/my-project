DELETE FROM DGM_DOCUMENT_GENERATION_MASTER WHERE DGM_ID='DGM-DFT-PI-C5' AND DOC_ID='CREATE_DFT_PI' AND SEQUENCE_ORDER=5 AND IS_CONCENTRATE='N';
DELETE FROM DGM_DOCUMENT_GENERATION_MASTER WHERE DGM_ID='DGM-DFT-PI-IOC_BM' AND DOC_ID='CREATE_DFT_PI' AND SEQUENCE_ORDER=6 AND IS_CONCENTRATE='N';
DELETE FROM DGM_DOCUMENT_GENERATION_MASTER WHERE DGM_ID='DGM-DFT-PI-ITD_BM' AND DOC_ID='CREATE_DFT_PI' AND SEQUENCE_ORDER=7 AND IS_CONCENTRATE='N';
DELETE FROM DGM_DOCUMENT_GENERATION_MASTER WHERE DGM_ID='DGM-DFT-PI-API_BM' AND DOC_ID='CREATE_DFT_PI' AND SEQUENCE_ORDER=8 AND IS_CONCENTRATE='N';
COMMIT;

declare fetchQueryISDDraftPI clob:= 'INSERT INTO is_d
...
fetchQueryISChildDraftPI clob := 'INSERT INTO is_child_d
...
fetchQueryBDSDraftPI clob :='INSERT INTO is_bds_child_d
...
fetchQueryBDPDraftPI clob :='INSERT INTO is_bdp_child_d
            (internal_invoice_ref_no, beneficiary_name, bank_name, account_no,
...
fetchQueryISPCDraftPI clob := 'INSERT INTO is_parent_child_d
...
fetchQueryIOCDraftPIBM clob :='INSERT INTO ioc_d
...
fetchQueryITDDraftPIBM clob :='INSERT INTO itd_d
...
fetchQueryAPIDDraftPIBM clob :='INSERT INTO API_DETAILS_D(
...
BEGIN
    UPDATE DGM_DOCUMENT_GENERATION_MASTER DGM SET DGM.FETCH_QUERY=fetchQueryISDDraftPI WHERE DGM.DGM_ID='DGM-DFT-PI' AND DGM.DOC_ID='CREATE_DFT_PI' AND DGM.SEQUENCE_ORDER=1 AND DGM.IS_CONCENTRATE='N';

    UPDATE DGM_DOCUMENT_GENERATION_MASTER DGM SET DGM.FETCH_QUERY=fetchQueryISChildDraftPI WHERE DGM.DGM_ID='DGM-DFT-PI-C1' AND DGM.DOC_ID='CREATE_DFT_PI' AND DGM.SEQUENCE_ORDER=2 AND DGM.IS_CONCENTRATE='N';

    UPDATE DGM_DOCUMENT_GENERATION_MASTER DGM SET DGM.FETCH_QUERY=fetchQueryBDSDraftPI WHERE DGM.DGM_ID='DGM-DFT-PI-C3' AND DGM.DOC_ID='CREATE_DFT_PI' AND DGM.SEQUENCE_ORDER=3 AND DGM.IS_CONCENTRATE='N';

    UPDATE DGM_DOCUMENT_GENERATION_MASTER DGM SET DGM.FETCH_QUERY=fetchQueryBDPDraftPI WHERE DGM.DGM_ID='DGM-DFT-PI-C4' AND DGM.DOC_ID='CREATE_DFT_PI' AND DGM.SEQUENCE_ORDER=4 AND DGM.IS_CONCENTRATE='N';
 ...
 Values
   ('DGM-DFT-PI-C5', 'CREATE_DFT_PI', 'Draft Provisional Invoice', 'CREATE_DFT_PI', 5, 
    fetchQueryISPCDraftPI, 'N');
    
    Insert into DGM_DOCUMENT_GENERATION_MASTER
   (DGM_ID, DOC_ID, DOC_NAME, ACTIVITY_ID, SEQUENCE_ORDER, 
    FETCH_QUERY, IS_CONCENTRATE)
 Values
   ('DGM-DFT-PI-IOC_BM', 'CREATE_DFT_PI', 'Draft Provisional Invoice', 'CREATE_DFT_PI', 6, 
    fetchQueryIOCDraftPIBM, 'N');
    
    Insert into DGM_DOCUMENT_GENERATION_MASTER
   (DGM_ID, DOC_ID, DOC_NAME, ACTIVITY_ID, SEQUENCE_ORDER, 
    FETCH_QUERY, IS_CONCENTRATE)
 Values
   ('DGM-DFT-PI-ITD_BM', 'CREATE_DFT_PI', 'Draft Provisional Invoice', 'CREATE_DFT_PI', 7, 
    fetchQueryITDDraftPIBM, 'N');
    
    Insert into DGM_DOCUMENT_GENERATION_MASTER
   (DGM_ID, DOC_ID, DOC_NAME, ACTIVITY_ID, SEQUENCE_ORDER, 
    FETCH_QUERY, IS_CONCENTRATE)
 Values
   ('DGM-DFT-PI-API_BM', 'CREATE_DFT_PI', 'Draft Provisional Invoice', 'CREATE_DFT_PI', 8, 
    fetchQueryAPIDDraftPIBM, 'N');
