...
BEGIN
UPDATE DGM_DOCUMENT_GENERATION_MASTER DGM SET DGM.FETCH_QUERY=fetchQueryDGMIGD WHERE DGM.DGM_ID IN ('DGM-DFIC-IGD','DGM-FIC-IGD','DGM-PIC-IGD') AND DGM.DOC_ID IN ('CREATE_DFI','CREATE_FI','CREATE_PI') AND DGM.SEQUENCE_ORDER IN (12) AND DGM.IS_CONCENTRATE = 'Y';

UPDATE DGM_DOCUMENT_GENERATION_MASTER DGM SET DGM.FETCH_QUERY=fetchQueryDGMIGDB WHERE DGM.DGM_ID IN ('DGM-PI-BMIGD','DGM-FI-BMIGD','DGM-DFI-BMIGD') AND DGM.DOC_ID IN ('CREATE_PI','CREATE_FI','CREATE_DFI') AND DGM.SEQUENCE_ORDER IN (9,11) AND DGM.IS_CONCENTRATE = 'N';
