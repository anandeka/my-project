...
update DC_DOCUMENT_CONFIGURATION dc set DC.IS_GENERATE_DOC_REQD = 'Y' where DC.ACTIVITY_ID = 'warehouseReceipt'

---------------------------
-- INSERT IN DGM SCRIPT
--------------------------------
