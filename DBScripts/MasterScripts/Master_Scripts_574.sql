declare 
fetchQueryISDDraftINTC clob := 'INSERT INTO IS_CONC_TC_CHILD (
...
fetchQueryISBDSForDFTINRC clob := 'INSERT INTO IS_CONC_RC_CHILD(
        INTERNAL_INVOICE_REF_NO,
        RC_AMOUNT,
        ELEMENT_NAME,
        ELEMENT_ID,
...
begin
    UPDATE DGM_DOCUMENT_GENERATION_MASTER DGM SET DGM.FETCH_QUERY = fetchQueryISDDraftINTC WHERE DGM.DGM_ID in ('CREATE_DFT_FIC_3','CREATE_DFT_PIC_3','CREATE_DFT_DFIC_3') AND DGM.DOC_ID in ('CREATE_DFT_FI','CREATE_DFT_PI','CREATE_DFT_DFI') and DGM.SEQUENCE_ORDER = '3' and DGM.IS_CONCENTRATE = 'Y';
    UPDATE DGM_DOCUMENT_GENERATION_MASTER DGM SET DGM.FETCH_QUERY = fetchQueryISBDSForDFTINRC WHERE DGM.DGM_ID in ('CREATE_DFT_FIC_4','CREATE_DFT_PIC_4','CREATE_DFT_DFIC_4') AND DGM.DOC_ID in ('CREATE_DFT_FI','CREATE_DFT_PI','CREATE_DFT_DFI') and DGM.SEQUENCE_ORDER = '4' and DGM.IS_CONCENTRATE = 'Y';
