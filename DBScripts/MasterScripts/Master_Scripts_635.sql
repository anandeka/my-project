...
BEGIN
   UPDATE dgm_document_generation_master dgm
      SET dgm.fetch_query = fetchqueryisdfor_piconc
   ...
   UPDATE dgm_document_generation_master dgm
      SET dgm.fetch_query = fetchqueryisdfor_ficonc
   ...
   UPDATE dgm_document_generation_master dgm
      SET dgm.fetch_query = fetchqueryisdfor_dficonc
    WHERE dgm.doc_id = 'CREATE_DFI'
      AND dgm.dgm_id = 'DGM-DFIC'
      AND dgm.sequence_order = 1
      AND dgm.is_concentrate = 'Y';
