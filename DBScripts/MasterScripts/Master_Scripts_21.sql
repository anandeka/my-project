Insert into AXM_ACTION_MASTER
 ...
 Values
   ('CREATE_JVS', 'Invoice ', 'Create JV Settlement Invoice', 'N', 'JV Settlement Invoice Creation', 
    'N');
...
Insert into CAC_CORPORATE_ACTION_CONFIG
 ...
 Values
   ('CREATE_JVS', NULL, NULL, NULL, 'Y', 
    NULL, NULL, NULL, 'Y');

Insert into AKM_ACTION_REF_KEY_MASTER
   (ACTION_KEY_ID, ACTION_KEY_DESC, VALIDATION_QUERY)
 Values
   ('JVSRefNo', 'JVS Ref No', 'SELECT COUNT(*) FROM   AXS_ACTION_SUMMARY axs WHERE  axs.action_ref_no = :pc_action_ref_no AND    axs.corporate_id = :pc_corporate_id');