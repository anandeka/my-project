declare
fetchQrySI CLOB := 'INSERT INTO IS_CHILD_SI_D(
...
and CM.CUR_ID IN (CS.TRANSACTION_AMT_CUR_ID,CS.INVOICE_CURRENCY)
and INVS.INVOICE_TYPE = ''Service''
and INVS.INTERNAL_INVOICE_REF_NO = ?';


begin
    UPDATE DGM_DOCUMENT_GENERATION_MASTER dgm set DGM.FETCH_QUERY = fetchQrySI where DGM.DOC_ID IN ('CREATE_SI') and DGM.DGM_ID IN ('DGM-SI-1','DGM-SIC-1') and DGM.SEQUENCE_ORDER = 2;
commit;
end;