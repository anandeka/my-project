DECLARE fetchQueryISDForSI CLOB :='INSERT INTO IS_D(
INVOICE_REF_NO,
INVOICE_TYPE_NAME,
...
pcm.is_self_billing';
BEGIN
UPDATE DGM_DOCUMENT_GENERATION_MASTER DGM SET DGM.FETCH_QUERY=fetchQueryISDForSI WHERE DGM.DGM_ID IN ('DGM-SI','DGM-SIC','DGM-DFT-SIC','DGM-DFT-SI') AND DGM.SEQUENCE_ORDER=1;
COMMIT;
END;