declare
fetchQryIEPD CLOB := 'INSERT INTO ioc_d
...
begin
    UPDATE DGM_DOCUMENT_GENERATION_MASTER dgm set DGM.FETCH_QUERY = fetchQryIEPD where DGM.DOC_ID IN ('CREATE_DFI','CREATE_FI','CREATE_PI') and DGM.DGM_ID IN ('DGM-IOC_C','DGM-IOC_C','DGM-IOC_C') and DGM.IS_CONCENTRATE = 'Y' and DGM.SEQUENCE_ORDER = 9;
commit;
end;