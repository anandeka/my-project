...
BEGIN
   ...
   UPDATE dgm_document_generation_master dgm
      SET dgm.fetch_query = fetchqryis_ddft_piconc
   ...
   UPDATE dgm_document_generation_master dgm
      SET dgm.fetch_query = fetchqryis_ddft_dficonc
   ...
   UPDATE dgm_document_generation_master dgm
      SET dgm.fetch_query = fetchqryis_ddft_ficonc
   ...
   UPDATE dgm_document_generation_master dgm
      SET dgm.fetch_query = fetchqryis_ddft_dcconc
   ...
   UPDATE dgm_document_generation_master dgm
      SET dgm.fetch_query = fetchqryis_ddft_si
