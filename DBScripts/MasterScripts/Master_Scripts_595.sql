...
BEGIN
   DELETE FROM dgm_document_generation_master dgm
         WHERE dgm.doc_id = 'CREATE_DFT_DC'
           AND dgm.dgm_id = 'DGM-DFT-IOC-CONC'
           AND dgm.sequence_order = 3
           AND dgm.is_concentrate = 'Y';

   INSERT INTO dgm_document_generation_master
        VALUES ('DGM-DFT-IOC-CONC', 'CREATE_DFT_DC',
                'Draft Debit Credit Note', 'CREATE_DFT_DC', 3,
