...
DECLARE
   fetchqryis_dpi_conc        CLOB
      := 'INSERT INTO is_d
            (invoice_ref_no, invoice_type_name, invoice_creation_date,
             ...
             prov_percentage, provisional_invoice_amount, smelter_location, senders_ref_no, internal_doc_ref_no)
   WITH TEST AS
   ...
   SELECT   invs.invoice_ref_no AS invoice_ref_no,
            ...
            invs.prov_pctg_amt AS provisional_invoice_amount, phd3.companyname AS smelter_location, gmr.senders_ref_no, ?
       FROM is_invoice_summary invs,
   ...
   fetchqryis_ddfi_conc       CLOB
      := 'INSERT INTO is_d
            (invoice_ref_no, invoice_type_name, invoice_creation_date,
             ...
             inco_term_location, notify_party, sales_purchase, invoice_status,
             freight_charge, adjustment_amount, total_premium_amount,
             our_person_incharge, internal_comments, is_self_billing, smelter_location, senders_ref_no, internal_doc_ref_no)
   WITH TEST AS
        (SELECT   invs.internal_invoice_ref_no, SUM (asm.net_weight) AS wet,
                  SUM (asm.dry_weight) AS dry
             FROM is_invoice_summary invs,
   ...
   SELECT   invs.invoice_ref_no AS invoice_ref_no,
            ...
            invs.invoice_adjustment_amount AS adjustment_amount,
            invs.total_premium_amount AS total_premium_amount,
            (GAB.FIRSTNAME||'' ''||GAB.LASTNAME) AS our_person_incharge,INVS.INTERNAL_COMMENTS as internal_comments, pcm.is_self_billing, phd3.companyname AS smelter_location, gmr.senders_ref_no, ?
       FROM is_invoice_summary invs,
            iid_invoicable_item_details iid,
            pcm_physical_contract_main pcm,
            v_pci pci,
   ...
   fetchqryis_ddc_conc        CLOB
      := 'INSERT INTO is_d
            (invoice_ref_no, invoice_type_name, invoice_creation_date,
             ...
             inco_term_location, notify_party, sales_purchase, invoice_status,
             our_person_incharge, internal_comments, is_self_billing,
             smelter_location, senders_ref_no, internal_doc_ref_no)
   SELECT   invs.invoice_ref_no AS invoice_ref_no,
            invs.invoice_type_name AS invoice_type_name,
            invs.invoice_issue_date AS invoice_creation_date,
            ...
            phd3.companyname AS smelter_location, gmr.senders_ref_no, ?
       FROM is_invoice_summary invs,
            iid_invoicable_item_details iid,
            pcm_physical_contract_main pcm,
            v_pci pci,
...
stragg(gmr.senders_ref_no) as senders_ref_no, ?
from 
   ...
   fetchqryis_d_pi            CLOB
      := 'INSERT INTO is_d
            (invoice_ref_no, invoice_type_name, invoice_creation_date,
             ...
             adjustment_amount, our_person_incharge, is_self_billing, senders_ref_no, internal_doc_ref_no)
   SELECT   invs.invoice_ref_no AS invoice_ref_no,
            invs.invoice_type_name AS invoice_type_name,
            invs.invoice_issue_date AS invoice_creation_date,
            invs.invoiced_qty AS invoice_quantity,
            ...
            invs.invoice_adjustment_amount As adjustment_amount,
            (GAB.FIRSTNAME||'' ''||GAB.LASTNAME) AS our_person_incharge, pcm.is_self_billing, gmr.senders_ref_no,
            ?
       FROM is_invoice_summary invs,
            iid_invoicable_item_details iid,
            pcm_physical_contract_main pcm,
   ...
   fetchqryis_d_dc            CLOB
      := 'INSERT INTO is_d
            (invoice_ref_no, invoice_type_name, invoice_creation_date,
             ...
             cp_city, cp_state, cp_zip, contract_type, origin,
             inco_term_location, notify_party, sales_purchase, invoice_status,
             our_person_incharge, internal_comments, is_self_billing, senders_ref_no, internal_doc_ref_no)
   SELECT   invs.invoice_ref_no AS invoice_ref_no,
            invs.invoice_type_name AS invoice_type_name,
            invs.invoice_issue_date AS invoice_creation_date,
            invs.invoiced_qty AS invoice_quantity,
            ...
            pci.contract_type AS sales_purchase,
            invs.invoice_status AS invoice_status,
            NVL (akuser.login_name, '''') AS our_person_incharge, INVS.INTERNAL_COMMENTS as internal_comments, pcm.is_self_billing as IS_SELF_BILLING, gmr.senders_ref_no, ?
       FROM is_invoice_summary invs,
            iid_invoicable_item_details iid,
            pcm_physical_contract_main pcm,
            v_pci pci,
...
INVS.IS_INV_DRAFT as IS_INV_DRAFT,
invs.invoice_adjustment_amount As adjustment_amount,
(GAB.FIRSTNAME||'' ''||GAB.LASTNAME) AS our_person_incharge, pcm.is_self_billing as is_self_billing, stragg(gmr.senders_ref_no) as senders_ref_no, 
?
from 
IS_INVOICE_SUMMARY invs,
PCM_PHYSICAL_CONTRACT_MAIN pcm,
...
phd3.companyname';
   fetchqryis_d_dftpi_conc    CLOB
      := 'INSERT INTO is_d
            (invoice_ref_no, invoice_type_name, invoice_creation_date,
             ...
             inco_term_location, notify_party, sales_purchase, invoice_status,
             freight_charge, adjustment_amount, total_premium_amount,
             our_person_incharge, internal_comments, is_self_billing,PROV_PERCENTAGE, IS_INV_DRAFT, senders_ref_no, internal_doc_ref_no)
   WITH TEST AS
        (SELECT   invs.internal_invoice_ref_no, SUM (asm.net_weight) AS wet,
                  SUM (asm.dry_weight) AS dry
             FROM is_invoice_summary invs,
   ...
   SELECT   invs.invoice_ref_no AS invoice_ref_no,
            ...
            INVS.IS_INV_DRAFT, gmr.senders_ref_no, ?
       FROM is_invoice_summary invs,
            iid_invoicable_item_details iid,
            pcm_physical_contract_main pcm,
            v_pci pci,
   ...
   fetchqryis_d_dftdc_conc    CLOB
      := 'INSERT INTO is_d
            (invoice_ref_no, invoice_type_name, invoice_creation_date,
             ...
             cp_city, cp_state, cp_zip, contract_type, origin,
             inco_term_location, notify_party, sales_purchase, invoice_status,
             our_person_incharge, internal_comments, is_self_billing,is_inv_draft, senders_ref_no, internal_doc_ref_no)
   SELECT   invs.invoice_ref_no AS invoice_ref_no,
            invs.invoice_type_name AS invoice_type_name,
            invs.invoice_issue_date AS invoice_creation_date,
            invs.invoiced_qty AS invoice_quantity,
            ...
            pci.contract_type AS sales_purchase,
            invs.invoice_status AS invoice_status,
            NVL (akuser.login_name, '' '') AS our_person_incharge, INVS.INTERNAL_COMMENTS as internal_comments,pcm.is_self_billing as is_self_billing,INVS.IS_INV_DRAFT as is_inv_draft, gmr.senders_ref_no, ?
       FROM is_invoice_summary invs,
            iid_invoicable_item_details iid,
            pcm_physical_contract_main pcm,
            v_pci pci,
   ...
   fetchqryis_d_dftpi         CLOB
      := 'INSERT INTO is_d
            (invoice_ref_no, invoice_type_name, invoice_creation_date,
             ...
             sales_purchase, invoice_status, is_free_metal, is_pledge,
             internal_comments, total_premium_amount, prov_percentage, PROVISIONAL_INVOICE_AMOUNT,
             adjustment_amount, our_person_incharge, is_self_billing, IS_INV_DRAFT, senders_ref_no, internal_doc_ref_no)
   SELECT   invs.invoice_ref_no AS invoice_ref_no,
            invs.invoice_type_name AS invoice_type_name,
            invs.invoice_issue_date AS invoice_creation_date,
            invs.invoiced_qty AS invoice_quantity,
            ...
            invs.provisional_pymt_pctg AS prov_percentage, INVS.PROV_PCTG_AMT as PROVISIONAL_INVOICE_AMOUNT,
            invs.invoice_adjustment_amount As adjustment_amount,
            (GAB.FIRSTNAME||'' ''||GAB.LASTNAME) AS our_person_incharge, pcm.is_self_billing, INVS.IS_INV_DRAFT, gmr.senders_ref_no, 
            ?
       FROM is_invoice_summary invs,
            iid_invoicable_item_details iid,
            pcm_physical_contract_main pcm,
