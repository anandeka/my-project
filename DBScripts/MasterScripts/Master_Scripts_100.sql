...
Insert into IRC_INTERNAL_REF_NO_CONFIG
   (INTERNAL_REF_NO_KEY, PREFIX, SEQ_NAME)
 Values
   ('PK_APSD', 'ASD', 'SEQ_PK_ASD');


SET DEFINE OFF;
update GM_GRID_MASTER gm set DEFAULT_RECORD_MODEL_STATE = '[     
