delete from sls_static_list_setup sls where sls.list_type = 'reportList';
delete from slv_static_list_value slv where slv.value_id in ('Detailed','Summarized');
...
Insert into AMC_APP_MENU_CONFIGURATION
   (MENU_ID, MENU_DISPLAY_NAME, DISPLAY_SEQ_NO, MENU_LEVEL_NO, LINK_CALLED, 
    ...
    IS_DELETED)
 Values
   ('RPT-D255', 'Monthly Arrival Report', 22, 5, '/EkaReport/CommonFilter.do?method=populateFilter&docType=EOM&ReportID=255&ReportName=MonthlyArrivalReport.rpt&ExportFormat=HTML&isEodReport=Y', 
