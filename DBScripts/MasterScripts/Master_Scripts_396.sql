...
Insert into PRLTM_PORTLET_MASTER
 ...
 Values
   ('PRLTM-14', 'IVD-14', 'Price fixation in next 7 days', 'Price fixation in next 7 days', 'Y', 
    '/iekaDashboardPage.do?method=getPortletData&portletId=PRLTM-14', NULL, 'Y', 'N', '{"height":99,"titleConfig":{"titleType":"static","dynamicBy":"parent","titleKey":"Price fixation in next 7 days"},"autoLoad":true,"gridSummary":false,"gridHandler":true}', 
    'N');
Insert into PRLTM_PORTLET_MASTER
   (PORTLET_ID, VIEW_DEF_ID, PORTLET_NAME, PORTLET_DESCRIPTION, IS_GRPAHICAL_VIEW_BASED, 
    URL, JS_FILE_NAME, USE_STANDARD_SERVICE, IS_ALWAYS_DEPENDENT, CONFIG, 
 ...
 Values
   ('PRLTM-16', 'IVD-16', 'Warehouse stocks', 'Warehouse stocks', 'Y', 
    '/iekaDashboardPage.do?method=getPortletData&portletId=PRLTM-16', NULL, 'Y', 'N', '{"height":99,"titleConfig":{"titleType":"static","dynamicBy":"parent","titleKey":"Warehouse stocks"},"autoLoad":true,"gridSummary":false,"gridHandler":true}', 
    'N');
Insert into PRLTM_PORTLET_MASTER
   (PORTLET_ID, VIEW_DEF_ID, PORTLET_NAME, PORTLET_DESCRIPTION, IS_GRPAHICAL_VIEW_BASED, 
    URL, JS_FILE_NAME, USE_STANDARD_SERVICE, IS_ALWAYS_DEPENDENT, CONFIG, 
 ...
 Values
   ('PRLTM-15', 'IVD-15', 'Prompt dates in next 7 days', 'Prompt dates in next 7 days', 'Y', 
    '/iekaDashboardPage.do?method=getPortletData&portletId=PRLTM-15', NULL, 'Y', 'N', '{"height":99,"titleConfig":{"titleType":"static","dynamicBy":"parent","titleKey":"Prompt dates in next 7 days"},"autoLoad":true,"gridSummary":false,"gridHandler":true}', 
    'N');
Insert into PRLTM_PORTLET_MASTER
   (PORTLET_ID, VIEW_DEF_ID, PORTLET_NAME, PORTLET_DESCRIPTION, IS_GRPAHICAL_VIEW_BASED, 
    URL, JS_FILE_NAME, USE_STANDARD_SERVICE, IS_ALWAYS_DEPENDENT, CONFIG, 
 ...
 Values
   ('PRLTM-17', 'IVD-17', 'Delivered stocks', 'Delivered stocks', 'Y', 
    '/iekaDashboardPage.do?method=getPortletData&portletId=PRLTM-17', NULL, 'Y', 'N', '{"height":99,"titleConfig":{"titleType":"static","dynamicBy":"parent","titleKey":"Delivered stocks"},"autoLoad":true,"gridSummary":false,"gridHandler":true}', 
    'N');
Insert into PRLTM_PORTLET_MASTER
   (PORTLET_ID, VIEW_DEF_ID, PORTLET_NAME, PORTLET_DESCRIPTION, IS_GRPAHICAL_VIEW_BASED, 
    URL, JS_FILE_NAME, USE_STANDARD_SERVICE, IS_ALWAYS_DEPENDENT, CONFIG, 
 ...
 Values
   ('PRLTM-13', 'IVD-13', 'Broker Margin', 'Broker Margin', 'Y', 
    '/iekaDashboardPage.do?method=getPortletData&portletId=PRLTM-13', NULL, 'Y', 'N', '{"height":99,"titleConfig":{"titleType":"static","dynamicBy":"parent","titleKey":"Broker Margin"},"autoLoad":true,"gridSummary":false,"gridHandler":true}', 
    'N');
...
Insert into PRTLM_PORTAL_MASTER
   (PORTAL_ID, PORTAL_NAME, PORTAL_DESC, PORTAL_CATEGORY_ID, QUANTITY_DENOMINATOR, 
    ...
    IS_DELETED)
 Values
   ('PRTLM-3', 'Alerts', 'Alerts', 'DASHBOARD', 7, 
...
Insert into AMC_APP_MENU_CONFIGURATION
   (MENU_ID, MENU_DISPLAY_NAME, DISPLAY_SEQ_NO, MENU_LEVEL_NO, LINK_CALLED, 
    ...
    IS_DELETED)
 Values
   ('IEKA-19', 'Alerts', 25, 2, '/iekaDashboardPage.do?method=getPortalMetadataJson&portalId=PRTLM-3', 
