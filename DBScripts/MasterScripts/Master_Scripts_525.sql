...
begin
    UPDATE DGM_DOCUMENT_GENERATION_MASTER dgm set DGM.FETCH_QUERY = fetchQueryVAT where DGM.DOC_ID IN ('CREATE_VAT') and DGM.DGM_ID IN ('DGM-VAT-1','DGM-VAT-1-CONC') and DGM.SEQUENCE_ORDER = 1;
commit;
end;