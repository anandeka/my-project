...
begin
    ...
    UPDATE DGM_DOCUMENT_GENERATION_MASTER dgm set DGM.FETCH_QUERY = fetchQueryIPCM where DGM.DOC_ID IN ('CREATE_PI','CREATE_FI','CREATE_DFI') and DGM.DGM_ID IN ('DGM-PIC-IGD','DGM-FIC-IGD','DGM-DFIC-IGD') and DGM.IS_CONCENTRATE = 'Y' and DGM.SEQUENCE_ORDER = 12;
commit;
end;