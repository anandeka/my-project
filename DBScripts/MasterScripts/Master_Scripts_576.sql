DECLARE fetchQueryIOCBM clob := 'INSERT INTO ioc_d
...
BEGIN
    UPDATE DGM_DOCUMENT_GENERATION_MASTER DGM SET DGM.FETCH_QUERY=fetchQueryIOCBM WHERE DGM.DGM_ID IN ('DGM-DFI-C7','DGM-IOC_BM','DGM-IOC_BM') AND DGM.DOC_ID IN ('CREATE_DFI','CREATE_FI','CREATE_PI') AND DGM.IS_CONCENTRATE='N';
COMMIT;
END;