declare fetchQuerybds CLOB := 'INSERT INTO is_bds_child_d
...
fetchQuerybdp CLOB := 'INSERT INTO is_bdp_child_d
            (internal_invoice_ref_no, beneficiary_name, bank_name, account_no,
...
fetchQuerychild CLOB := 'INSERT INTO IS_DC_CONC_CHILD_D(
INTERNAL_INV_REF_NO,
ELEMENT_ID,
ELEMENT_NAME,
OLD_INVOICED_QTY,
...
begin
INSERT INTO DGM_DOCUMENT_GENERATION_MASTER(DGM_ID, DOC_ID, DOC_NAME, ACTIVITY_ID, SEQUENCE_ORDER, FETCH_QUERY, IS_CONCENTRATE) VALUES('DGM-DC-CONC-BDS','CREATE_DC','Debit Credit','CREATE_DC',6,fetchQuerybds,'Y');

INSERT INTO DGM_DOCUMENT_GENERATION_MASTER(DGM_ID, DOC_ID, DOC_NAME, ACTIVITY_ID, SEQUENCE_ORDER, FETCH_QUERY, IS_CONCENTRATE) VALUES('DGM-DC-CONC-BDP','CREATE_DC','Debit Credit','CREATE_DC',7,fetchQuerybdp,'Y');

INSERT INTO DGM_DOCUMENT_GENERATION_MASTER(DGM_ID, DOC_ID, DOC_NAME, ACTIVITY_ID, SEQUENCE_ORDER, FETCH_QUERY, IS_CONCENTRATE) VALUES('DGM-DC-CONC-C1','CREATE_DC','Debit Credit','CREATE_DC',2,fetchQuerychild,'Y');
commit;
end;