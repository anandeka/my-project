/* Formatted on 2013/03/20 12:51 (Formatter Plus v4.8.8) */
DECLARE
   ...
   IS
      SELECT t.gmr_ref_no, t.asm_id, t.elementscount, t.maxorder,
        ...
        FROM (SELECT   gmr.gmr_ref_no, asm.asm_id, COUNT (*) elementscount,
             ...
             gmr_goods_movement_record gmr
       WHERE t.elementscount != t.maxorder
         AND gmr.gmr_ref_no = t.gmr_ref_no
         AND axs.internal_action_ref_no = gmr.internal_action_ref_no
