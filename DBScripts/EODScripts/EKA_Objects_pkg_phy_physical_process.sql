  ...
  begin
    ...
    loop
      ...
      if cur_unrealized_rows.unit_of_measure = 'Wet' then
        vn_dry_qty := pkg_metals_general.fn_get_assay_dry_qty(cur_unrealized_rows.conc_product_id,
      ...
      vn_base_con_treatment_charge := pkg_general.f_get_converted_currency_amt(cur_unrealized_rows.corporate_id,
                                                                               vc_con_treatment_cur_id,
                                                                               cur_unrealized_rows.base_cur_id,
                                                                               pd_trade_date,
                                                                               vn_con_treatment_charge);
      ...
      vn_base_con_refine_charge := pkg_general.f_get_converted_currency_amt(cur_unrealized_rows.corporate_id,
                                                                            vc_con_refine_cur_id,
                                                                            cur_unrealized_rows.base_cur_id,
                                                                            pd_trade_date,
                                                                            vn_con_refine_charge);
      ...
      if cur_unrealized_rows.ele_rank = 1 then
        ...
        vn_base_con_penality_charge := pkg_general.f_get_converted_currency_amt(cur_unrealized_rows.corporate_id,
                                                                                vc_con_penality_cur_id,
                                                                                cur_unrealized_rows.base_cur_id,
                                                                                pd_trade_date,
                                                                                vn_con_penality_charge);
      ...
      pkg_general.sp_get_main_cur_detail(nvl(cur_unrealized_rows.m2m_price_unit_cur_id,
                                         ...
                                         vn_m2m_sub_cur_id_factor,
                                         vn_m2m_cur_decimals);
      vn_ele_m2m_amt := round(vn_ele_m2m_amt * vn_m2m_sub_cur_id_factor, 2);
  ...
  begin
    ...
    loop
      ...
      if cur_grd_rows.stock_qty <> 0 then
        ...
        pkg_general.sp_get_main_cur_detail(cur_grd_rows.price_unit_cur_id,
                                           vc_price_cur_id,
                                           vc_price_cur_code,
                                           vn_cont_price_cur_id_factor,
                                           vn_cont_price_cur_decimals);
      
        vn_contract_value_in_price_cur := (cur_grd_rows.contract_price /
                                          nvl(cur_grd_rows.price_unit_weight,
                                               1)) *
                                          (pkg_general.f_get_converted_quantity(cur_grd_rows.product_id,
                                                                                cur_grd_rows.qty_unit_id,
                                                                                cur_grd_rows.price_unit_weight_unit_id,
                                                                                cur_grd_rows.stock_qty)) *
                                          vn_cont_price_cur_id_factor;
      ...
      values
        (pc_process_id,
         ...
         cur_grd_rows.price_fixation_status, --cur_grd_rows.fixation_method
         cur_grd_rows.price_fixation_details,
         cur_grd_rows.contract_price,
         cur_grd_rows.price_unit_id,
         cur_grd_rows.price_unit_cur_id,
         cur_grd_rows.price_unit_cur_code,
         cur_grd_rows.price_unit_weight_unit_id,
         cur_grd_rows.price_unit_weight,
         cur_grd_rows.price_unit_weight_unit,
