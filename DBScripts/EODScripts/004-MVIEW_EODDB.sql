...
DROP MATERIALIZED VIEW MNM_MONTH_NAME_MASTER;
...
DROP TABLE MNM_MONTH_NAME_MASTER;

CREATE MATERIALIZED VIEW  MNM_MONTH_NAME_MASTER  REFRESH FAST ON DEMAND WITH PRIMARY KEY AS  SELECT * FROM  MNM_MONTH_NAME_MASTER@eka_appdb;
