...
create or replace package body pkg_phy_physical_process is
  ...
  begin
    ...
    begin
      ...
      update md_m2m_daily md
         set (valuation_location, reference_location, valuation_incoterm, valuation_location_country, reference_location_country)
             --
             = (select cim_val_loc.city_name,
                 ...
                 where md.valuation_city_id = cim_val_loc.city_id
                   and md.refernce_location_id = cim_ref_loc.city_id
                   and cim_val_loc_v.country_id = cim_val_loc.country_id
                   and cim_ref_loc_r.country_id = cim_ref_loc.country_id
                   and md.valuation_incoterm_id = itm.incoterm_id)
       where md.corporate_id = pc_corporate_id
         and md.process_id = pc_process_id;
  ...
  begin
    ...
    loop
      ...
      if cur_grd_rows.stock_qty <> 0 then
        ...
        vn_m2m_amt_per_unit:=round(vn_m2m_total_amount/vn_qty_in_base,8);                                    
      ...
      loop
        update psu_phy_stock_unrealized psu_today
           set psu_today.prev_day_pnl_in_val_cur     = cur_update.unreal_pnl_in_val_cur_per_unit *
               ...
               psu_today.prev_market_value           = round(nvl(cur_update.m2m_amt_per_unit,0) * psu_today.qty_in_base_unit,4),
